...
let CountByUser= React.createClass({
    displayName: 'CountByUser',
    ...
    _getCounts: function() {
        this.serverRequest = $.get('queryCountAllByUser',{
    ...
    _renderTable: function() {
        return (
            <div>
                <div id="managerTitle">
                    <p> counting the number of questions owned by each user </p>
                </div>
                <table>
